...
import il.co.skystar.databinding.ArrivalsFlightsLayoutBinding
...
@AndroidEntryPoint
class ArrivalsFlightsFragment : Fragment(R.layout.arrivals_flights_layout) {

    private var binding: ArrivalsFlightsLayoutBinding by autoCleared()
    ...
    override fun onCreateView(
        ...
        binding = ArrivalsFlightsLayoutBinding.inflate(layoutInflater)
...
//                    .addSwipeRightLabel("Add To Favorites")
        ...
        return RecordsAdapter(it.status.data!!, object : RecordsAdapter.ItemListener {
            ...
            override fun onItemClicked(index: Int) {
                ...
                itemBinding.apply {
                    ...
                    tvRealTimeToFlight.text = "${getString(R.string.ata)}: ${realDate} ${realTime}"
    ...
    private fun fetch() {
        ...
        viewModel.arrivals.observe(viewLifecycleOwner) {
            when (it.status) {
                is Loading -> {
